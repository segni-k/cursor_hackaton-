...
use App\Http\Controllers\User\Patient\DashboardController as PatientDashboard;
use App\Http\Controllers\User\Pharmacy\AnalyticsController;
use App\Http\Controllers\User\Pharmacy\DashboardController as PharmacyDashboard;
use App\Http\Controllers\User\Pharmacy\InventoryController;
use App\Http\Controllers\User\Pharmacy\OrderController as PharmacyOrderController;
use App\Http\Controllers\User\Pharmacy\PaymentController as PharmacyPaymentController;
use Illuminate\Support\Facades\Route;
use Inertia\Inertia;

/*
|--------------------------------------------------------------------------
| User app (authenticated patients & pharmacy owners)
|--------------------------------------------------------------------------
| URLs stay /patient/* and /pharmacy/* — only PHP & Inertia namespaces use User\.
*/
...
Route::middleware(['auth', 'role:patient'])->prefix('patient')->name('patient.')->group(function () {
    ...
    Route::get('/prescriptions/upload', function () {
        return Inertia::render('User/Patient/Prescriptions/Upload');
