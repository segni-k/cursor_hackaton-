...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('User/Pharmacy/Inventory/Index', [
    ...
    {
        return Inertia::render('User/Pharmacy/Inventory/Create', [
            'categories' => MedicineCategory::select('id', 'name', 'name_am')->get(),
        ]);
    }
    ...
    public function edit(Medicine $medicine)
    {
        ...
        return Inertia::render('User/Pharmacy/Inventory/Edit', [
            'medicine' => $medicine,
            'categories' => MedicineCategory::select('id', 'name', 'name_am')->get(),
        ]);
    }
